...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!./node_modules/cropperjs/dist/cropper.css":
/*!***********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!./node_modules/cropperjs/dist/cropper.css ***!
  \***********************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _css_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_2_cropper_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!../../postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!./cropper.css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!./node_modules/cropperjs/dist/cropper.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_2_cropper_css__WEBPACK_IMPORTED_MODULE_1__.default, options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_2_cropper_css__WEBPACK_IMPORTED_MODULE_1__.default.locals || {});
...
$(document).ready(function (e) {
  function doCropper(type) {
    ...
    reader.onload = function (e) {
      ...
      var unixtime = new Date().getTime(); // cache filename to re-assign it to cropped file

      var cachedFilename = unixtime + '_' + input_tag[0].files[0].name; // dynamically create modals to allow multiple files processing

      var $cropperModal = $(modalTemplate); // 'Crop and Upload' button in a modal
      ...
      $cropperModal.modal('show'); // listener for 'Crop and Upload' button in modal

      $uploadCrop.on('click', function () {
        // get cropped image data
        var blob = croping.getCroppedCanvas().toDataURL(input_tag[0].files[0].type, 0.9); // transform it to Blob object
        ...
        resizeImage({
          ...
          reader.onload = function (e) {
            ...
            newFile.cropped = true; // assign original filename

            newFile.name = cachedFilename; // add cropped file to dropzone
            // var unixtime = new Date().getTime();
            // var newFile = renameFile(reader, unixtime + '_' + $('#input_background_img')[0].files[0].name);

            var container = new DataTransfer();
            var newFileObject = new File([newFile], newFile.name);
            ...
            input_tag[0].files = container.files; // upload cropped file with dropzone
  ...
  $('#input_background_img').change(function () {
    ...
    //
    // reader.onload = (e) => {
    //     // if ($('#input_background_img')[0].files[0].cropped) {
    //     //     return;
    //     // }
    //     //
    //     // var unixtime = new Date().getTime();
    ...
    //     // var cachedFilename = unixtime + '_' + $('#input_background_img')[0].files[0].name;//unixtime 추가
    //     //
    ...
    //     //
    //     // // read uploaded file (triggers code above)
    //     // reader2.readAsDataURL($('#input_background_img')[0].files[0]);
    //     //
    ...
    //     // $uploadCrop.on('click', function() {
    //     //     // get cropped image data
    //     //     var blob = croping.getCroppedCanvas().toDataURL($('#input_background_img')[0].files[0].type, 0.9);
    ...
    //     //             var reader_preview = new FileReader();
    //     //             reader_preview.onload = function(e) {
    //     //                 $('#preview_background_img').attr('src', reader_preview.result);
    //     //             }
    //     //             reader_preview.readAsDataURL(newFile);
    //     //
    //     //             $('#input_background_img')[0].files = container.files;
    //     //
    //     //             // upload cropped file with dropzone
    //     //             $cropperModal.modal('hide');
    //     //         };
    //     //         reader.readAsDataURL($('#input_background_img')[0].files[0]);
    //     //     });
    //     // });
    //     // $cancelCrop.on('click', function() {
    //     //     $cropperModal.modal('hide');
