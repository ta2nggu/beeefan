@auth
    <div id="menuDrawerContent">
        <ul>
            ...
            <li><a href="{{ url('/help') }}" class="icon_help">{{__('ヘルプ')}}</a></li>
            <li><a href="{{ url('/rule') }}" class="icon_rule">{{__('利用規約')}}</a></li>
            <li><a href="{{ url('/policy') }}" class="icon_policy">{{__('プライバシーポリシー')}}</a></li>
            <li><a href="{{ url('/law') }}" class="icon_law">{{__('特定商取引法に基づく表記')}}</a></li>
            @endrole
            @role('user')
            <li><a href="{{ url('/user/index') }}" class="icon_mypage">{{__('マイページ')}}</a></li>
            <li><a href="" class="icon_post">{{__('メールアドレス変更')}}</a></li>
            <li><a href="" class="icon_setting">{{__('パスワード変更')}}</a></li>
            <li><a href="" class="icon_draft">{{__('決済方法変更')}}</a></li>
            <li><a href="{{ url('/help') }}" class="icon_help">{{__('ヘルプ')}}</a></li>
            <li><a href="{{ url('/rule') }}" class="icon_rule">{{__('利用規約')}}</a></li>
            <li><a href="{{ url('/policy') }}" class="icon_policy">{{__('プライバシーポリシー')}}</a></li>
            <li><a href="{{ url('/law') }}" class="icon_law">{{__('特定商取引法に基づく表記')}}</a></li>
